	...
	<div class="mob-header-content nz-clearfix">
		...
		<div class="container">
			...
			<?php if ($nz_h1_header_top == "true"): ?>
				...
				<?php if(isset($GLOBALS['montserrat_ninzio']["h1-top-button-text"]) && !empty($GLOBALS['montserrat_ninzio']["h1-top-button-text"])): ?>
					<a class="top-button" href="<?php echo esc_url($GLOBALS['montserrat_ninzio']["h1-top-button-url"]); ?>"><?php echo esc_attr($GLOBALS['montserrat_ninzio']["h1-top-button-text"]); ?></a>
				<?php endif; ?>
